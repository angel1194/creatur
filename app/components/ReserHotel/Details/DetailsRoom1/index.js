  ...
  return (
    <ContainerRoom>
      ...
      <DetailsRooms>
        ...
        <RadioButtonGreen text='2 camas dobles'  ID='3' name='Habitacion3'/>
        <RadioButtonGreen text='1 cama doble'  ID='4' name='Habitacion'/>
      ...
      <ContainerPrice>
        ...
        <H3>$2,089.56 <Label>USD</Label></H3>
...
DetailsRoom1.propTypes = {

};

export default DetailsRoom1;
