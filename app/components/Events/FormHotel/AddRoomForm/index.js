      ...
      <div>
        ...
        <div className="dad-reservHotel">
          <div className="childHotel">
            ...
            <select className="inputs" name='adult' onChange={(e)=>this.props.inputValueChange(this.props.object,e)}>
              <option>1</option>
              <option>2</option>
              <option>3</option>
              <option>4</option>
          ...
          <div className="childHotel">
            ...
            <select className="inputs" name='baby' onChange={(e)=>this.props.inputValueChange(this.props.object,e)}>
              <option>0</option>
              <option>1</option>
              <option>2</option>
            </select>
          ...
          <div className="childHotel">
            ...
            <select className="inputs" name='child' onChange={this.addAgeInput}>
              <option>0</option>
              <option>1</option>
              <option>2</option>
            </select>
