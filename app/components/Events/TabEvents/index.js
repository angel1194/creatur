...
class TabEvents extends React.Component {
  ...
  renderForm(){
    if(this.state.ubicacion==='hotel'){
      return(<FormSearchHotel input='manzanero' button='manzanero' title='Bienvenido' setLocation={this.props.setLocation} type={this.props.type} saveDataHotel={this.props.saveDataHotel} saveRoomsAdult={this.props.saveRoomsAdult}/>
    )
    }else if(this.state.ubicacion==='car'){
      return(<FormSearchHotel input='manzanero' button='manzanero' title='Bienvenido' setLocation={this.props.setLocation} type={this.props.type} saveDataHotel={this.props.saveDataHotel} saveRoomsAdult={this.props.saveRoomsAdult}/>
    )
    }else if (this.state.ubicacion==='transport') {
    return(<FormTransport title='Bienvenido' />
    )
    }
  }
